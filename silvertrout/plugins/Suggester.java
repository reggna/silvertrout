...
import jbt.Channel;
import jbt.User;
import jbt.commons.ConnectHelper;
 ...
 * @version Beta 3.0
 */
public class Suggester extends jbt.Plugin {
  ...
  public void onPrivmsg(User user, Channel channel, String message) {
    ...
    if(channel == null || !channel.getName().equals("#it06")) return;
    for(String s: message.split(" ")){
      ...
      for(User u: channel.getUsers().keySet())
        if(s.contains(u.getNickname())) s = "hej";
      ...
      String t;
      if(old.containsKey(s)) t = old.get(s);
      else t = getSuggestion(s);
      old.put(s, t);
      
      /* if we have found a suggestion, print it to the channel */
      if(t != null) channel.sendPrivmsg(t);
    }
  }
