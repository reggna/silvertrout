 ...
 * @version Beta 3.0
 */
public class TitleGiver extends jbt.Plugin {
  ...
  public void onPrivmsg(User user, Channel channel, String message) {
    ...
    for(String t: s) {
      if(channel != null) channel.sendPrivmsg(t);
      else getNetwork().sendPrivmsg(user.getNickname(), t);
    }
  }
  ...
  public static List<String> getTitles(String message){
    ...
    while(m.find()){
      ...
      if(title != null && !title.equals(""))r.add(title);
    }
    return r;
  }
